 ...
 private:
    ...
    class ServerTransactionHandler : public proxygen::HTTPTransactionHandler {
     ...
     private:
        ...
        void detachTransaction() noexcept override { parent_.detachServerTransaction(); }
        ...
        void onEOM() noexcept override { parent_.onServerEOM(); }
        ...
        void onEgressPaused() noexcept override { parent_.onServerEgressPaused(); }
        void onEgressResumed() noexcept override { parent_.onServerEgressResumed(); }
    };
    ...
    std::string forward_body_;
    std::string forward_url_;
    std::string rsp_body_;
    std::string 

    bool need_forward_{false};
